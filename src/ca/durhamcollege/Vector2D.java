/**
 * This application is a replica from our C++ Vector2D class.
 *
...
public class Vector2D
{
    ...
    {
        final double delta_x = (double)(b.getX()) - (double)(a.getX());
        final double delta_y = (double)(b.getY()) - (double)(a.getY());
